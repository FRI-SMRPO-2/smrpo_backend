# Generated by Django 3.0.4 on 2020-04-18 19:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_owner', to=settings.AUTH_USER_MODEL)),
                ('scrum_master', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='scrum_master', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Sprint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimated_time', models.FloatField(validators=[smrpo.models.task.higher_than_zero])),
                ('assignee_accepted', models.DateTimeField(blank=True, null=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ...
                ('assignee_awaiting', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assignee_awaiting', to=settings.AUTH_USER_MODEL)),
